...
#ifndef RHEA_AST_STMT_EMPTY_HPP
#define RHEA_AST_STMT_EMPTY_HPP
...
class EmptyStatement final : public ASTNode {
public:
    explicit EmptyStatement(std::shared_ptr<Token> _address) {
