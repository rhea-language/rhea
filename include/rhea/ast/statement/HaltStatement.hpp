...
#ifndef RHEA_AST_STMT_HALT_HPP
#define RHEA_AST_STMT_HALT_HPP
...
class HaltStatement final : public ASTNode {
public:
    explicit HaltStatement(std::shared_ptr<Token> _address) {
